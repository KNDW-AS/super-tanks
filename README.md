...
> **What is in this repository:** the governance layers (`core/`), 1,475 tests and the ZEF red-team corpus.
...
python -m supertanks test        # 1,475 tests, ~80 s, offline
```
...
> sets up Python, runs the 1,475 tests and the ZEF red-team corpus.
